...
{
    internal class CustomerDLDB : IUserDL, ICustomerDL
    {
        ...
        public string UserSignIn(UserBL user)
        {
            ...
            string query = $"SELECT * FROM Customers WHERE Username COLLATE Latin1_General_BIN = @Username AND Password COLLATE Latin1_General_BIN = @Password;";
